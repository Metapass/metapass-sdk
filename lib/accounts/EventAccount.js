 ...
 */
class EventAccount {
    constructor(title, description, uri, link, fee, seats, occupiedSeats, date, collection, venue, authority, creators, eventHost, eventNonce, bump, isCutPayedByCreator) {
        this.title = title;
    ...
    static fromArgs(args) {
        return new EventAccount(args.title, args.description, args.uri, args.link, args.fee, args.seats, args.occupiedSeats, args.date, args.collection, args.venue, args.authority, args.creators, args.eventHost, args.eventNonce, args.bump, args.isCutPayedByCreator);
    }
    /**
